...
int main(int argc, char *argv[]) 
{
  ...
  ofp1 = fopen("src/navigation-indigo-devel/ltl_multi_planner/utils/examples/ltlconstraints.txt", "w");
  ofp2 = fopen("src/navigation-indigo-devel/ltl_multi_planner/utils/examples/ltlvariables.txt", "w");
  system("ls");
